...
@customElement('tooltip-button')
export class TooltipButton extends LitElement {
    render() {
        return html`
            <link rel="stylesheet" href="/src/components/atoms/buttons/tooltip-button/tooltip-button.css" />
